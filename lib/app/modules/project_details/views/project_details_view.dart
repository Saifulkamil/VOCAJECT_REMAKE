                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Builder(
                                    builder: (context) {
                                      ...
                                      String? selectedImage = categoryImage[
                                          controller
                                              .dataProject!.data.category.name];
                                  ...
                                  Flexible(
                                    child: Text(
                                      "${controller.dataProject!.data.title}",
                                      maxLines: 3,
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text(
                                        "${controller.dataProject!.data.deadline_at}",
                                        style: whiteTextStyly.copyWith(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${controller.dataProject!.data.description}",
                                          maxLines: 14,
                                          overflow: TextOverflow.ellipsis,
                                          style: ColorApp.secondColorTextStyly(
                                                  context)
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    Get.toNamed(Routes.PROFILE_INDUSTRI, arguments: controller.dataProject);
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.all(15.0),
                                    child: Container(
                                              ...
                                              children: [
                                                CircleAvatar(
                                                  backgroundImage: AssetImage(
                                                    "${controller.dataProject!.data.company.picture}",
                                                  ),
                                                  backgroundColor:
                                                ...
                                                Expanded(
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "${controller.dataProject!.data.company.name}",
                                                        ...
                                                        const SizedBox(
                                                            height: 5),
                                                        Text(
                                                          "${controller.dataProject!.data.company.address}",
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          style: ColorApp
                                                                  .secondColorTextStyly(
                                                        ...
                                                        const SizedBox(
                                                            height: 5),
                                                        Text(
                                                          "${controller.dataProject!.data.company.email}",
                                                          style: ColorApp
                                                                  .secondColorTextStyly(
                                                                      context)
                                                              .copyWith(
