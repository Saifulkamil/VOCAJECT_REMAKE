                                          ...
                                          children: [
                                            CircleAvatar(
                                              backgroundImage: NetworkImage(
                                                  "${controller.dataProfile!.data.user.picture}"),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            SizedBox(
                                              width: 190,
                                              child: Text(
                                                "${controller.dataProfile!.data.user.name}",
                                                maxLines: 1,
                                            ...
                                            controller.dataProfile!.data.user
                                                        .role ==
                                                    "student"
                                                ? Text(
                                                    controller.dataProfile!.data
                                                                .user.role !=
                                                            "student"
                                                        ? "NIDN ${controller.dataProfile!.data.user.nidn}"
                                                        : "NIM ${controller.dataProfile!.data.user.nim}",
                                                    style: ColorApp
                                                            .secondColorTextStyly(
                                                                context)
                                                        .copyWith(
                                  ...
                                  IconButton(
                                      onPressed: () {
                                        Get.toNamed(Routes.EDIT_PROFILE,
                                            arguments: controller.dataProfile);
                                      },
                                      icon: const Icon(
                                        Icons.edit,
                                        size: 30,
